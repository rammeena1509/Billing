                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->cashier_name ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->cashier_email ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="help-block"></p>
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->cashier_mobile ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="help-block"></p>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-2 col-md-offset-2">
                                                <div class="input-group input-icon right">
                                                    <button type="button"class="btn btn-success btn-flat btn-pri btn-md" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit" aria-hidden="true"></i>Change Password</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <input class="form-control1" placeholder="Enter Old Password" id="opassword"/>
                            </div>
                        </div><br/>
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <input class="form-control1" placeholder="Enter New Password" id="npassword"/>
                            </div>
                        </div><br/>
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <input class="form-control1" placeholder="Enter Re-enter New Password" id="cnpassword"/>
                            </div>
                        </div><br/>
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <button class="btn btn-success" id="change-pass">Update</button>
                            </div>
                        </div>
                </div>
