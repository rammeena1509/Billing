                                    ...
                                    <div class="col-lg-12">
                                        <table class="table table-bordered"> 
                                            <tbody> 
                                                ...
                                                <tr> <th>Customer Id</th> <td><a href="<?= base_url('cashier/viewcustomer/') ?>"><button class="btn btn-success"><?= $row->customer_id ?></button></a></td></tr>  
                                                <tr> <th>Amount</th> <td><?= $row->total_price ?></td></tr>  
                                                <tr> <th>Date</th> <td><?= $row->order_date ?></td></tr>  
                                                <tr><td colspan="2"><center><a href="<?= base_url('cashier/detailbill/'.$row->order_id) ?>"><button type="button"class="btn btn-primary">View More</button></a></center></td></tr>
                                            </tbody>  
                                        </table>
					                </div>
                                </div>
