				        ...
				        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="customer_name" name="<?= $this->uri->segment(3) ?>" value="<?= $data->customer_name ?>"/>
                                    </div>   
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <button type="button" class="btn btn-success update-customer" value="customer_name">Update</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="customer_mobile" name="<?= $this->uri->segment(3) ?>" value="<?= $data->customer_mobile ?>"/>
                                    </div>   
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <button type="button" class="btn btn-success update-customer" value="customer_mobile">Update</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="customer_email" name="<?= $this->uri->segment(3) ?>" value="<?= $data->customer_email ?>"/>
                                    </div>   
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <button type="button" class="btn btn-success update-customer" value="customer_email">Update</button>
                            </div>
                        </div>
