	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                <h3 class="title1">Add Cashier</h3>
            ...
            <?php endif; ?>
				    <form method="post" action="" id="cashier-form">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="name" class="cols-sm-2 control-label">Cashier Name</label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                            <input type="text" class="form-control" name="cname" id="cname"  placeholder="Cashier Name" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="email" class="cols-sm-2 control-label">Cashier Mobile</label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-phone fa" aria-hidden="true"></i></span>
                                            <input type="text" class="form-control" name="cmobile" id="cmobile" placeholder="Cashier Mobile" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="email" class="cols-sm-2 control-label">Cashier Email</label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                                            <input type="text" class="form-control" name="cmail" id="cmail" placeholder="Cashier Email" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
