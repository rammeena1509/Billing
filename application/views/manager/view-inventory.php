		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                <div class="blank-page widget-shadow scroll" id="style-2 div1">
                    <h3 class="title1">View Inventory</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <table class="table table-bordered"> 
                                            <tbody> 
                                                <tr> <th>Product Id</th> <td><?= $row->product_id ?></td></tr>  
                                                <tr> <th>Product Name</th> <td><?= $row->product_name ?></td></tr>  
                                                <tr> <th>Product Category</th> <td><?= $row->product_category ?></td></tr>  
                                                <tr> <th>Sub-Category</th> <td><?= $row->product_subcat ?></td></tr>  
                                                <tr> <th>Product Price</th> <td><?= $row->product_price ?></td></tr>  
                                                <tr> <th>Product Discount</th> <td><?= $row->product_discount ?></td></tr>  
                                                <tr> <th>Discount Type</th> <td><?= $discount ?></td></tr>  
                                                <tr> <th>Max Discount</th> <td><?= $row->max_discount ?></td></tr>  
                                                <tr> <th>Product Discription</th> <td><?= $row->product_discription ?></td></tr> 
                                                <tr><td colspan="2"><center><a href="<?= base_url('manager/updateinventory/'.$row->product_id) ?>"><button type="button"class="btn btn-primary">Update</button></a></center></td></tr>
                                            </tbody> 
                                        </table>
					                </div>
                                </div>
