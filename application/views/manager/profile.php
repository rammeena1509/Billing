                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->im_name ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->im_email ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="help-block"></p>
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">							
                                                   <span class="input-group-addon">
                                                    ...
                                                    <input type="text" class="form-control1" readonly value="<?= $data->im_mobile ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="help-block"></p>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <button class="btn btn-success" id="change-password">Update</button>
                            </div>
                        </div>
                </div>
