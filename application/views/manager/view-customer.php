		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                <div class="blank-page widget-shadow scroll" id="style-2 div1">
                    <h3 class="title1">View Customer</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <table class="table table-bordered"> 
                                            <tbody> 
                                                <tr> <th>Customer Id</th> <td><?= $row->customer_id ?></td></tr>  
                                                <tr> <th>Customer Name</th> <td><?= $row->customer_name ?></td></tr>  
                                                <tr> <th>Customer Mobile</th> <td><?= $row->customer_mobile ?></td></tr>  
                                                <tr> <th>Customer Email</th> <td><?= $row->customer_email ?></td></tr>  
                                                <tr> <th>Rewards Point</th> <td><?= $row->reward_point ?></td></tr>  
                                                <tr><td colspan="2"><center><a href="<?= base_url('manager/updatecustomer/'.$row->customer_id) ?>"><button type="button"class="btn btn-primary">Update</button></a></center></td></tr>
                                            </tbody> 
                                        </table>
					                </div>
                                </div>
